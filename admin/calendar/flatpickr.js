/* flatpickr v4.6.13,, @license MIT */ ! function(e, n) {
    ...
    function k(p, v) {
        ...
        function R(e, n, t, a) {
            ...
            o.type = "button";
            o.textContent = n.getDate().toString();
            ...
            if (i) {
                ...
                o.tabIndex = -1;  // Keep disabled dates untabbable
            }
            ...
            if (w.weekNumbers && 1 === w.config.showMonths && "prevMonthDay" !== e && a % 7 == 6) {
                w.weekNumbers.insertAdjacentHTML("beforeend", "<span class='flatpickr-day'>" + w.config.getWeek(n) + "</span>");
            }
